...
class LabelImage(models.Model):
    ...
    sole = models.ManyToManyField(Sole, related_name="sole")
    material = models.ManyToManyField(Material, related_name='meterial')
    printing = models.ManyToManyField(Printing, related_name='printing')
    detail = models.ManyToManyField(Detail, related_name='detail')
